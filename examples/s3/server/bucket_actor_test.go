...
func TestBucketActor_Create(t *testing.T) {
	...
	resp, walEntry, err := a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "photos", Region: "us-east-1"})
...
func TestBucketActor_Get(t *testing.T) {
	a := newBucket()
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "photos", Region: "ap-northeast-2"})

	t.Run("existing", func(t *testing.T) {
		resp, walEntry, err := a.Receive(nil, s3common.BucketRequest{Op: "get", Name: "photos"})
		require.NoError(t, err)
		require.True(t, resp.Found)
	...
	t.Run("not found", func(t *testing.T) {
		resp, _, err := a.Receive(nil, s3common.BucketRequest{Op: "get", Name: "videos"})
		require.NoError(t, err)
...
func TestBucketActor_Delete(t *testing.T) {
	a := newBucket()
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "photos", Region: "us-east-1"})

	_, walEntry, err := a.Receive(nil, s3common.BucketRequest{Op: "delete", Name: "photos"})
	require.NoError(t, err)
	require.NotNil(t, walEntry, "delete should produce a WAL entry")

	resp, _, _ := a.Receive(nil, s3common.BucketRequest{Op: "get", Name: "photos"})
	require.False(t, resp.Found, "bucket should not be found after delete")
}

func TestBucketActor_UnknownOp(t *testing.T) {
	a := newBucket()
	_, _, err := a.Receive(nil, s3common.BucketRequest{Op: "invalid"})
	require.Error(t, err)
}
...
func TestBucketActor_WALReplay(t *testing.T) {
	...
	a := newBucket()
	_, walAlpha, _ := a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "alpha", Region: "us-east-1"})
	_, walBeta, _ := a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "beta", Region: "eu-west-1"})
	_, walGamma, _ := a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "gamma", Region: "ap-northeast-2"})
	_, walDeleteBeta, _ := a.Receive(nil, s3common.BucketRequest{Op: "delete", Name: "beta"})
	...
	for name, shouldExist := range map[string]bool{"alpha": true, "beta": false, "gamma": true} {
		resp, _, _ := restored.Receive(nil, s3common.BucketRequest{Op: "get", Name: name})
...
func TestBucketActor_SnapshotRestore(t *testing.T) {
	...
	original := newBucket()
	original.Receive(nil, s3common.BucketRequest{Op: "create", Name: "alpha", Region: "us-east-1"})
	original.Receive(nil, s3common.BucketRequest{Op: "create", Name: "beta", Region: "eu-west-1"})
...
func TestBucketActor_Split(t *testing.T) {
	...
	a := newBucket()
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "apple", Region: "us-east-1"})
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "banana", Region: "us-east-1"})
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "cherry", Region: "eu-west-1"})
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "date", Region: "eu-west-1"})
	...
	for _, name := range []string{"cherry", "date"} {
		resp, _, _ := upper.Receive(nil, s3common.BucketRequest{Op: "get", Name: name})
	...
	for _, name := range []string{"apple", "banana"} {
		resp, _, _ := a.Receive(nil, s3common.BucketRequest{Op: "get", Name: name})
...
func TestBucketActor_KeyCount(t *testing.T) {
	...
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "alpha", Region: "us-east-1"})
	a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "beta", Region: "eu-west-1"})
	require.EqualValues(t, 2, a.KeyCount())

	a.Receive(nil, s3common.BucketRequest{Op: "delete", Name: "alpha"})
...
func TestBucketActor_WALEntryFormat(t *testing.T) {
	...
	a := newBucket()
	_, walEntry, _ := a.Receive(nil, s3common.BucketRequest{Op: "create", Name: "photos", Region: "us-east-1"})
